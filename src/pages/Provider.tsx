  ...
  return (
    <div className="space-y-8 max-w-[1440px]">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-2 font-mono text-[11px]">Register and manage your GPU resources</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <GlassCard gradient delay={0.1} className="p-6 space-y-4">
          ...
          <Button variant="outline" className="w-full gap-2 border-white/[0.06] bg-transparent hover:bg-white/[0.04] text-white/60 transition-all duration-300">
            <Play className="h-4 w-4" /> Run Benchmark Test
          </Button>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" size="sm" className="gap-2 text-[10px] font-mono border-white/[0.06] bg-transparent hover:bg-white/[0.04] text-white/50">
              <Plus className="h-4 w-4" /> Add GPU
            </Button>
          </div>
          ...
          <GlassCard delay={0.2} corners className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-white/40 mt-1">Model: NVIDIA H100 80GB</p>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={stat.label} className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.04]">
                  ...
                  <p className="font-mono text-sm font-medium mt-2">{stat.value}</p>
                </div>
              ))}
            </div>
            ...
            <div className="flex gap-2">
              {[
                ...
                <Button key={action.label} variant="outline" size="sm" className="text-[10px] gap-2 border-white/[0.06] bg-transparent hover:bg-white/[0.04] text-white/50 transition-all duration-300">
          ...
          <GlassCard delay={0.3} glow className="p-6 space-y-4">
            ...
            <div className="space-y-0">
              {[
                ...
                <div key={label} className="flex justify-between py-4 border-b border-white/[0.04] last:border-0">
